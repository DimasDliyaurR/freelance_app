...
if (!empty($selectedCategory) && $_GET['kategori'] !== 0) {
    $sql .= "  INNER JOIN kategori USING(idKategori) WHERE idKategori = '$selectedCategory' AND statusUlas = 'belum diulas'";
}else{
    $sql .= " WHERE statusUlas = 'belum diulas'";
}
                    ...
                    <div class="col">
                        <div class="project-wrapper d-flex flex-column shadow-sm">
                            ...
                            <div class="content-main d-flex flex-row mt-3 px-4">
                                <div class="img-avatar" style="width:80px;height:fit-content;">
                                    <img src="img/profile.png" alt="" class="avatar-freelancer" />
                                </div>
                                <div class="namaFreelancer mx-3" style="width:200px;height:fit-content;">
                                    <h4 class="mb-2"><?= $project['freelancer'] ?></h4>
                                    <div class="role"><p>Freelancer</p></div>
                                </div>
                                <div class="line-project-card mb-3"></div>
                                <div class="d-flex flex-column project ms-5">
                                    <h3>Project</h3>
                                    <img src="img/project1.png" alt="" class="gambarProject" />
                                </div>
                                <div class="judul-project d-flex flex-column justify-content-center ms-4">
                                    <h6><?= $project['judul'] ?></h6>
                                    <div class="text">
                                        <p style="text-transform: capitalize;"><?= $project['statusUlas'] ?></p>
                                        <a class="btn" href="beriulasan.php?id=<?= $project['idProject'] ?>">Beri ulasan</a>
                                        <!-- <a class="btn" href="beriulasan.php?id=<?= $project['idProject'] ?>">Beri ulasan</a> -->
                                    </div>
                                </div>
                            </div>
