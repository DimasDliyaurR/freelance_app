...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['idProject'], $_POST['bintang'], $_POST['ulasan'])) {
        ...
        if (empty($bintang) || empty($ulasan)) {
            ...
            $sql = "INSERT INTO ulasan(ratedIndex, ulasan, idProject) VALUES ('$bintang', '$ulasan','$idProject')";
            $terulas = "UPDATE project SET statusUlas = 'sudah diulas' WHERE idProject = $idProject";

            if ($conn->query($sql) === TRUE && $conn->query($terulas) === TRUE) {
                ...
                >
                    <div class="col">
                        ...
                        >
                            ...
                            >
                                <p class="invoice">Freelancer : <?= $datas['freelancer'] ?></p>
                                <p class="tgl-pesanan">
                                    Pesanan diterima: <?=date('d F Y', strtotime($datas['tglTerima']));?>
                                </p>
                            </div>
                            <div
